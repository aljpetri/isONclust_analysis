...
def plot_dataset_new(dataset_name, data, outfolder):
    ...
    sns.lineplot(x='Threshold', y='Value', hue='Measure', data=melted_data,linewidth=3)
...
outfolder= "/home/alexanderpetri/isONclust_analysis/Results_paper_16-10-2024/Thresholds/"
